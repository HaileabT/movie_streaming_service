...
export default function FavoritesPage() {
  ...
  useEffect(() => {
    fetchFavorites(setFavorites, setIsLoading, show, setError);
    fetchWatchLater(setWatchLater, setIsLoading, show, setError);
  }, [show]);
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {favorites.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">Start adding movies to your favorites to see them here</p>
